...
def run_gffread(outbase, genome_assembly, annotation_target, path, kinds=[]):
    ...
    for kind in kinds:
            ...
            if outfile.is_file():
                ...
                last_result.append({"outfile": outfile, "log_msg": log_msg, "returncode": 0,
                            "cmd": cmd})
            else:
                ...
                if results.returncode == 0:
                    ...
                    last_result.append({"outfile": outfile, "log_msg": log_msg, "returncode": results.returncode,
                            "cmd": cmd})
    return last_result
