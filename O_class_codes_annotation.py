...
def plot_valencia_class_codes(base_path, annotation_mapping, output_filename="osativa_class_codes_comparison.svg"):
    """
    ...
    # Updated title for Oryza sativa
    ax.set_title('Distribution of class codes by annotation type (Oryza sativa)', fontsize=14, fontweight='bold', pad=15)
...
if __name__ == "__main__":
    ...
    # Path updated to point to your Oryza folder
    my_base_path = "../Oryza_sativa_dataset_test"
