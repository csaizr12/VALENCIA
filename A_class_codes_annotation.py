...
def plot_valencia_class_codes(base_path, annotation_mapping, output_filename="athaliana_class_codes_comparison.svg"):
    """
    ...
    ax.set_title('Distribution of class Codes by annotation type (Arabidopsis thaliana)', fontsize=14, fontweight='bold', pad=15)
