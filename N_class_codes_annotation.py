...
def plot_valencia_class_codes(base_path, annotation_mapping, output_filename="nbenthamiana_class_codes_comparison.svg"):
    """
    ...
    # Updated title for Nicotiana benthamiana
    ax.set_title('Distribution of class codes by annotation type (Nicotiana benthamiana)', fontsize=14, fontweight='bold', pad=15)
...
if __name__ == "__main__":
    ...
    # Path updated to point to your Nicotiana folder
    my_base_path = "../Nicotiana_benthamiana_dataset_test"
